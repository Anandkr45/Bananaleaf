...
<html lang="en">
  ...
  <body>
            ...
            <div class="card ml-lg-4 my-5 categorycard">
              ...
              <ul class="list-group list-group-flush">
                ...
                <?php
                    ...
                    while( $p_cart_record = mysqli_fetch_assoc($p_cat_result) ) {
                ?>  
                <a href="#<?php echo str_replace(' ', '',(strtolower($p_cart_record['p_cat_title']))); ?>"><li class="list-group-item"><?php echo $p_cart_record['p_cat_title'];?></li></a>
                <?php } ?>
    ...
    <div class="container">
      ...
      <div class="text-center">&copy; Copyright Banana Leaf 2023</div>
    </div>
  </footer>
